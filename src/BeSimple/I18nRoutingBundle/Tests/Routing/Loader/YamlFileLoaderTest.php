...
class YamlFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getPathsToInvalidFiles()
    {
        return [
            ['nonvalid_array.yml'],
            ['nonvalid_extrakeys.yml'],
            ['nonvalid_type_without_resource.yml'],
            ['nonvalid_without_resource_and_locales.yml'],
        ];
    }
    ...
    {
        return [['nonvalid_resource_with_locales.yml'],];
    }
    ...
    {
        return new YamlFileLoader(new FileLocator([__DIR__.'/../../Fixtures']));
    }
}
